...
#' # or
#' results <- SwarnSeq::SwarnAdjLRT(CountData = CountData, norm.method = "DEseq.norm", group = group, CellCluster = CellCluster, RNAspike.use = T, spikes = TestData$SpikeCounts, spike.conc = TestData$SpikeConc)
