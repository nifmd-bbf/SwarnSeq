...
#' # or
#' ExtractedAdjNormData <- SwarnSeq::ExtAdjNormData(CountData = counts_data_matrix, norm.method = "DEseq.norm", group = group, RNAspike.use = T, spikes = spike_counts, spike.conc = spike_conc_vector, CE.range = c(0.01, o.5))
